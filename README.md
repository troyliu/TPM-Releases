...
| 工具 | 用途 | 系統需求 | 最新穩定版 |
| --- | --- | --- | --- |
| [TPMSmokeTest](tools/TPMSmokeTest.md) | 官網與據點叫車自動化測試工具 | macOS、VS Code 1.96+ | [0.0.8](https://github.com/troyliu/TPM-Releases/releases/tag/TPMSmokeTest-v0.0.8) · [下載](https://github.com/troyliu/TPM-Releases/releases/download/TPMSmokeTest-v0.0.8/tpm-smoke-test-0.0.8.vsix) |
