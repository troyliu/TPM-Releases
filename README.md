...
| [TPMAzureAssistCLI](tools/TPMAzureAssistCLI.md) | Azure DevOps 命令列工具 | macOS ARM64、Node.js 26.5+ | [0.3.5](https://github.com/troyliu/TPM-Releases/releases/tag/TPMAzureAssistCLI-v0.3.5) · [下載](https://github.com/troyliu/TPM-Releases/releases/download/TPMAzureAssistCLI-v0.3.5/tpm-azure-assist-macos-arm64-v0.3.5) |
